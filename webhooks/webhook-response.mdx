...
description: "Learn how to receive and handle Finogates webhook events."
icon: "wifi"
---
...
Finogates sends webhook events to notify your application about payment status changes. This allows you to keep your system synchronized with payment updates in real-time.
