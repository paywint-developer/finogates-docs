---
title: "Overview"
description: "Learn how Finogates uses webhooks to deliver real-time event notifications."
icon: "book-open"
---

Finogates webhooks allow your application to receive **real-time notifications** whenever an event occurs — such as a payment success, wallet funding, or KYC approval.
...
2. Finogates sends a `POST` request to that URL whenever an event occurs.
