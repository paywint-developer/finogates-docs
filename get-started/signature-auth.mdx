...
description: How to generate HMAC-SHA256 signatures for secure API access in Finogates.
keywords: ['signature', 'signature authentication']
icon: "shield"
---

All requests to Finogates APIs must be authenticated using an HMAC-SHA256 signature. This ensures both the integrity and authenticity of your requests.
