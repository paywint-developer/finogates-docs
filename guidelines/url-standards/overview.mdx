...
description: "Overview of URL requirements and validation rules for submitting documents through the Finogates API."
icon: "link"
---

## Overview

Some Finogates API endpoints—such as KYB verification, document submission, and compliance checks—require you to provide direct URLs to documents.  
...
Finogates validates each document URL to ensure:
...
These URL rules apply whenever you submit a document through Finogates, including:
