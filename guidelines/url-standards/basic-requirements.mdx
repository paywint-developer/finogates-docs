...
description: "Core rules every document URL must follow before being submitted to Finogates APIs."
icon: "check-circle"
---

## Overview

All document URLs submitted to Finogates—such as for KYC/KYB verification—must follow strict security and format rules. These requirements ensure the file can be safely downloaded, scanned, and processed by our systems.
...
Finogates downloads the file once during validation, so the URL must not:
